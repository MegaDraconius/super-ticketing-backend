...
public class CountryControllerTest
{
        ...
        public async Task Get_ReturnsListOfCountryDtos()
        {
            ...
            {
                new Country { Id = ObjectId.GenerateNewId().ToString(), CountryCode = "US", CountryName = "United States", CountryMainLanguage = "English" },
                new Country { Id = ObjectId.GenerateNewId().ToString(), CountryCode = "ES", CountryName = "Spain", CountryMainLanguage = "Spanish" }
            };
